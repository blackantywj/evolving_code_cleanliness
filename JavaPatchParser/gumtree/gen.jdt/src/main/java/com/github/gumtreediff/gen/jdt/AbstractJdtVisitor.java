...
public abstract class AbstractJdtVisitor extends ASTVisitor {
    ...
    protected void pushNode(ASTNode n, String label) {
        ...
        ITree tree = push(type, typeName, label, n.getStartPosition(), n.getLength());
        tree.setAttach(n);
    }
    ...
    protected ITree push(int type, String typeName, String label, int startPosition, int length) {

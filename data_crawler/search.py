...
TOKENS = []  # api token 可以添加多个，提高访问速度
...
if __name__ == "__main__":
    ...
    parser.add_argument('-df', '--download_flag', type=int, default=1,
    ...
    # url = f"https://api.github.com/repos/spring-projects/spring-framework/commits/50b1fb0b15d944e9f426b770308828ca28dc25c6/check-runs"
    # response = get_response(url)
    # result = response.json()
    # pass